...
publicApp.controller('HomeCtrl', ['$scope', '$localStorage', '$interval', 'Data','$timeout','$location' ,'$routeParams', 'User','$window',function($scope, $localStorage, $interval,Data, $timeout,$location,$routeParams,User,$window){
...
publicApp.controller('loginCtrl', ['$scope', 'User', '$document', '$mdToast','$location', '$window', '$localStorage', function($scope, User, $document, $mdToast,$location,$window, $localStorage){
